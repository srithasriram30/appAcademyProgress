...
// detremines if the given number is five
describe("isFive(num)", () => {
...
describe("isOdd(number)", () => {
  ...
  //check if variable is of type number; will throw an error if it's not
...
// if the step variable is not provided, the function will use 1 as the step value; otherwise it will use the given value
