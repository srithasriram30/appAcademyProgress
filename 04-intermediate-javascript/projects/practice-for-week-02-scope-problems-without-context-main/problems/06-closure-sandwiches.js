...
function sandwichMaker() {
  let mySandwitch = "One sandwich with tomato and "
  let ingredients = [];
  // Your code here
  return function sandwitch(ingredient){

    ingredients.push(ingredient);

    let ingredientList = ingredients.join(' and ');

    return mySandwitch + ingredientList;
